<script src="js/header_home_check.js"></script>

<div class="header">
                <a href="index.php">
                    <strong id="header_blog_name">
				<i title="Home" class="icon-home nav_icons selected" style="position: relative;top: 2.5px;padding: 10px"></i>
				Raja Narasimha Karthik Tangirala (trnkarthik)
		    </strong>
                </a>
